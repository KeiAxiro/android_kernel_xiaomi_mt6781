...
struct opp_table_info g_opp_table_segment_1[] = {
    GPUOP(1025000, 90750, 100000, POSDIV_POWER_2, 625),
    GPUOP(940000, 89812, 98907, POSDIV_POWER_4, 625),
    GPUOP(930000, 88532, 98282, POSDIV_POWER_4, 625),
    GPUOP(920000, 87807, 97657, POSDIV_POWER_4, 625),
    GPUOP(910000, 87782, 97032, POSDIV_POWER_4, 625),
    GPUOP(900000, 87157, 96407, POSDIV_POWER_4, 625),
    GPUOP(890000, 86532, 95782, POSDIV_POWER_4, 625),
    GPUOP(880000, 85907, 95157, POSDIV_POWER_4, 625),
    GPUOP(870000, 84282, 94532, POSDIV_POWER_4, 625),
    GPUOP(860000, 83657, 93907, POSDIV_POWER_4, 625),
    GPUOP(850000, 82032, 93282, POSDIV_POWER_4, 625),
    GPUOP(840000, 81407, 92657, POSDIV_POWER_4, 625),
    GPUOP(830000, 80782, 92032, POSDIV_POWER_4, 625),
    GPUOP(820000, 80157, 91407, POSDIV_POWER_4, 625),
    GPUOP(810000, 79532, 90782, POSDIV_POWER_4, 625),
    GPUOP(800000, 79063, 90313, POSDIV_POWER_4, 625),
    GPUOP(790000, 78438, 89688, POSDIV_POWER_4, 625),
    GPUOP(775000, 77813, 89063, POSDIV_POWER_4, 625),
    GPUOP(761000, 77188, 88438, POSDIV_POWER_4, 625),
    GPUOP(746000, 76563, 87813, POSDIV_POWER_4, 625),
    GPUOP(732000, 75938, 87188, POSDIV_POWER_4, 625),
    GPUOP(718000, 75313, 86563, POSDIV_POWER_4, 625),
    GPUOP(703000, 74813, 85938, POSDIV_POWER_4, 625),
    GPUOP(689000, 74213, 85313, POSDIV_POWER_4, 625),
    GPUOP(675000, 73638, 84688, POSDIV_POWER_4, 625),
    GPUOP(660000, 73063, 84132, POSDIV_POWER_4, 625),
    GPUOP(646000, 72438, 84375, POSDIV_POWER_4, 625),
    GPUOP(631000, 71613, 84219, POSDIV_POWER_4, 625),
    GPUOP(617000, 71000, 84063, POSDIV_POWER_4, 625),
    GPUOP(603000, 70438, 83907, POSDIV_POWER_4, 625),
    GPUOP(588000, 69763, 83750, POSDIV_POWER_4, 625),
    GPUOP(574000, 69163, 83594, POSDIV_POWER_4, 625),
    GPUOP(560000, 68563, 83438, POSDIV_POWER_4, 625),
    GPUOP(543000, 67938, 83282, POSDIV_POWER_4, 625),
    GPUOP(527000, 67288, 83125, POSDIV_POWER_4, 625),
    GPUOP(511000, 66613, 82969, POSDIV_POWER_4, 625),
    GPUOP(495000, 66032, 82813, POSDIV_POWER_4, 625),
    GPUOP(478000, 65469, 82657, POSDIV_POWER_4, 625),
    GPUOP(462000, 64938, 82500, POSDIV_POWER_4, 625),
    GPUOP(446000, 64313, 82344, POSDIV_POWER_4, 625),
    GPUOP(430000, 63688, 82188, POSDIV_POWER_4, 625),
    GPUOP(413000, 63313, 82032, POSDIV_POWER_4, 625),
    GPUOP(397000, 62750, 82188, POSDIV_POWER_4, 625),
    GPUOP(381000, 62125, 82032, POSDIV_POWER_4, 625),
    GPUOP(365000, 61500, 81875, POSDIV_POWER_8, 625),
    GPUOP(348000, 60875, 81719, POSDIV_POWER_8, 625),
    GPUOP(332000, 60250, 81563, POSDIV_POWER_8, 625),
    GPUOP(316000, 59625, 81532, POSDIV_POWER_8, 625),
    GPUOP(300000, 59000, 81375, POSDIV_POWER_8, 625) // Koma dihilangkan di baris terakhir
};
